...
const getTeacher_subject = async ( req, res , next) =>{
  try{
    const db = getDB();
...
const addTeacher_subject = async (req, res , next) =>{
  try{
    const db = getDB();
...
const updateTeacher_subject = async (req, res , next) =>{
  try{
    const db = getDB();
...
const deleteTeacher_subject = async (req, res , next) =>{
  try{
    const db = getDB();
